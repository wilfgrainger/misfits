      ...
      <div className="admin-block">
        ...
        <form className="compact-form create-league-form" aria-labelledby="create-league-title" onSubmit={createLeague}>
          <div className="create-form-intro">
            <p className="section-kicker">NEW LEAGUE</p>
            <h3 id="create-league-title">Create a league</h3>
            <p className="form-help">Set the rules first, then invite players to join.</p>
          </div>
          <label htmlFor="new-league-name">League name<input id="new-league-name" placeholder="e.g. Tuesday Club" value={newName} onChange={(event) => setNewName(event.target.value)} required /></label>

...
**Cloudflare Worker version:** `4bce27c5-91a0-4f7d-a51e-bd24bb0d00c2`<br>
...
- The checks above were rerun after deployment of Worker version `4bce27c5-91a0-4f7d-a51e-bd24bb0d00c2`; the custom domain served the generic app, health endpoint, manifest/icon and all public slug resources with `200`, while the unauthenticated admin routes and invalid Google credential returned `401`.

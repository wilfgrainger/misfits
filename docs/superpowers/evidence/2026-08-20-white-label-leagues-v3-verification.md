...
**Cloudflare Worker version:** `97e274c7-6444-48e8-bed9-b49a400a1d8f`<br>
...
- `npm test`: 24 test files, 98 tests passed.
...
- The checks above were rerun after deployment of Worker version `97e274c7-6444-48e8-bed9-b49a400a1d8f`; the custom domain served the generic app, health endpoint, manifest/icon and all public slug resources with `200`, while the unauthenticated admin route and invalid Google credential returned `401`.
...
- Playwright at a current `390x844` viewport on Worker `97e274c7-6444-48e8-bed9-b49a400a1d8f` showed the generic `LB` mark, `DARTS / LEAGUES`, `Leagues, properly settled.`, the public league card and the official Google button without visible overlap or horizontal clipping. The captured mobile screenshot was `.playwright-cli/white-label-mobile-20260820.png`; that artifact is local and intentionally untracked.

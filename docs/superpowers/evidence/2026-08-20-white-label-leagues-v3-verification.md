...
**Cloudflare Worker version:** `5208c35c-369f-4d81-bbd8-615403fc30c1`<br>
...
- Playwright at a current `390x844` viewport on Worker `5208c35c-369f-4d81-bbd8-615403fc30c1` showed the generic `LB` mark, `DARTS / LEAGUES`, `Leagues, properly settled.`, the public league card and the official Google button without visible overlap or horizontal clipping. The captured mobile screenshot was `output/playwright/live-390-signed-out.png`; that artifact is local and intentionally untracked.

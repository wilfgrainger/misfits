...
- `npm test`: 24 test files, 97 tests passed.
...
- The checks above were rerun after deployment of Worker version `4eec687b-a9aa-4029-8477-534658b5e015`; the custom domain served the generic app, health endpoint, manifest/icon and all public slug resources with `200`, while the unauthenticated admin routes and invalid Google credential returned `401`.

...
**Cloudflare Worker version:** `64188e1c-16f9-4b4e-a99c-da5342791df7`<br>
...
- The checks above were rerun after deployment of Worker version `64188e1c-16f9-4b4e-a99c-da5342791df7`; the custom domain served the generic app and all public slug resources with `200`, while the unauthenticated admin route and invalid Google credential remained `401`.

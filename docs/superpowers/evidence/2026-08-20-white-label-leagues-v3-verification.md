...
> **Historical evidence:** This verifies the deployed v3 baseline; it is not the current product direction. See the [v4 club design](../specs/2026-08-20-misfits-501-club-v4-design.md).
